package devandroid.moacir.pookotlinencapsulamento
...
class MainActivity : AppCompatActivity() {
    ...
    private fun criarObjetos() {
        ...
        Log.i("POO-1","Obj Livro: Autor: "+autor);
        Log.i("POO-1","Obj Livro: Titulo: "+titulo);
        Log.i("POO-1","Obj Livro: Editora: "+editora);
        Log.i("POO-1","Obj Livro: Pag: "+paginas);
        Log.i("POO-1","Obj Livro: Localização: "+localizacao);
